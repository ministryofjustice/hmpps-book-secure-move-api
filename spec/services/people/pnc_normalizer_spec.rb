...
RSpec.describe People::PncNormalizer do
  ...
  it 'handles 4-digit year and unpadded' do
    ...
    expect(variants).to include('2014/012018R')
  end

  it 'matches 2-digit search against 4-digit DB' do
    db = create(:person, police_national_computer: '2014/120018R')
    expect(Person.filter_by_pnc_canonical('14/120018R')).to include(db)
  end
