...
RSpec.describe FrameworkResponse::MultipleItemsCollection, type: :model do
  ...
  context 'with validations' do
    it 'validates the object passed' do
      ...
      collection = described_class.new(collection: collection, assessment: person_escort_record, questions: questions)
    ...
    it 'validates the object type passed' do
      ...
      collection = described_class.new(collection: collection, assessment: person_escort_record, questions: [question])
  ...
  describe '#to_a' do
    ...
    it 'returns an empty array if collection is empty' do
      collection = described_class.new(collection: [], assessment: person_escort_record)
