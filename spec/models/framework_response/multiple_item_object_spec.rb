...
RSpec.describe FrameworkResponse::MultipleItemObject, type: :model do
  ...
  context 'with validations' do
    it 'ignores other keys passed in' do
      ...
      object = described_class.new(attributes: attributes, questions: questions, assessment: person_escort_record)
    ...
    it 'validates type of responses key' do
      ...
      expect { described_class.new(attributes: attributes, questions: questions, assessment: person_escort_record) }.to raise_error(FrameworkResponse::ValueTypeError)
    end
  ...
  describe '#as_json' do
    ...
    it 'returns an empty hash if nothing passed in' do
      questions = [create(:framework_question, :checkbox, required: true)]
      object = described_class.new(attributes: {}, questions: questions, assessment: person_escort_record)
