...
module PersonalCareNeeds
  class Importer
    ...
    DEFAULT_PROBLEM_CODE_MAPPING = { domain: DOMAIN_UNKNOWN, question_key: QUESTION_KEY_FALLBACK }
    ...
    def call
      assessment_answers = personal_care_needs.map do |personal_care_need|
        ...
        AssessmentAnswer.from_nomis_personal_care_need(personal_care_need, question) 
      end 
    ...
    def find_assessment_question(ques)
