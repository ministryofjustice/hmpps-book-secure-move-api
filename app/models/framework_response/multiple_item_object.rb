...
class FrameworkResponse
  class MultipleItemObject
    ...
    attr_accessor :questions, :item, :responses, :assessment
    ...
    def initialize(attributes: {}, questions: [], assessment:)
  ...
  private
    ...
    def response_objects
      @response_objects ||= responses.map { |response|
        ...
        framework_response = framework_question.build_response(framework_question, assessment)
