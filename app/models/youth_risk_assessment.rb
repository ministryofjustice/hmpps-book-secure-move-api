class YouthRiskAssessment < VersionedModel
  ...
  def build_responses!
    ApplicationRecord.retriable_transaction do
      ...
      questions.values.each do |question|
        ...
        response = question.build_responses(assessment: self, questions: questions, previous_responses: previous_responses)
  ...
  def import_nomis_mappings!
    ...
    FrameworkNomisMappings::Importer.new(assessment: self).call
  end
