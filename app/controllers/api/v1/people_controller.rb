  ...
  module V1
    class PeopleController < ApiController
      ...
      PERSON_ATTRIBUTES = [
        ...
        :last_name,
        :date_of_birth,
        risk_alerts: [%i[date expiry_data title comments assessment_answer_type_id]],
        health_alerts: [%i[date expiry_data title comments assessment_answer_type_id]],
        court_information: [%i[date expiry_data title comments assessment_answer_type_id]],
